# Python - Network #0
In this networking project, I employed the `curl` command within Bash scripts to
transmit a variety of HTTP headers. This hands-on experience deepened my understanding
of URL structures, domain names, the diverse set of HTTP request and response header
fields, as well as HTTP status codes. Additionally, I gained proficiency in working
with cookies for managing sessions and user interactions.

Task six involved an algorithmic challenge, which was unrelated to the theme of the project.
This challenge was tackled using Python, showcasing my skills in algorithm development
and problem-solving in a different context.
...
server set up on a container provided by ALX SE School.
