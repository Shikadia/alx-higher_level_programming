...
the answers within individual .txt files, each containing a single line of response.

## Description of the Project Task Files

* [tests](./tests): Folder of test files provided by ALX SE School.

* [0-answer.txt](./0-answer.txt): Contains the function used to print the type of an object.

* [1-answer.txt](./1-answer.txt): Contains the keyword used to get a variable's identifier
